...
namespace slowcontrol {
	class configValueBase {
	  ...
	  public:
		...
		virtual void fSave(const char *aTable, const char *aIdColumn, int aId, const char *aComment) const;
		virtual void fUpdate(const char *aTable, const char *aIdColumn, int aId, const char *aComment) const;
		static void fConfigure(const char *aTable, const char *aIdColumn, int aId, mapType& aMap);
